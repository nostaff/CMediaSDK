...
Pod::Spec.new do |s|
  ...
  s.name         = "SFAdMsAdapter"
  s.version      = "2.7.0" # 版本号
  s.summary      = "SFAdMsAdapter is a AD SDK Adapter."
  s.description  = <<-DESC
                   ‘CMedia provides Union ADs which include native、banner、feed、splash、RewardVideo etc..’
                   DESC
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.author       = { "小富" => "3290235031@qq.com" }

  s.homepage     = "https://github.com/nostaff/CMediaSDK"
  ...
  s.vendored_frameworks =  'CMediaSDK/Frameworks/SFAdMsAdapter.framework'
  
  s.xcconfig = { "OTHER_LDFLAGS" => "-ObjC" }
  s.pod_target_xcconfig = { 'VALID_ARCHS[sdk=iphonesimulator*]' => '' }

  s.dependency 'MSMobAdSDK/MS', '~>1.4.6.0'
