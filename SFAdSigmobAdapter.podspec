...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ‘CMedia provides Union ADs which include native、banner、feed、RewardVideo etc..’
                   DESC
  ...
  s.vendored_frameworks =  'CMediaSDK/Frameworks/SFAdSigmobAdapter.framework'
  
  s.xcconfig = { "OTHER_LDFLAGS" => "-ObjC" }
  s.pod_target_xcconfig = { 'VALID_ARCHS[sdk=iphonesimulator*]' => '' }

  s.dependency 'SigmobAd-iOS', '~>4.9.0'
